...
-- Which army they are in determines where the other races are
if gb:get_army(ai_alliance, 1, "reinforcements") then
	ga_ai_grey_seer_clan = gb:get_army(ai_alliance, 1, "reinforcements");
elseif gb:get_army(ai_alliance, 2, "reinforcements") then	
	ga_ai_grey_seer_clan = gb:get_army(ai_alliance, 2, "reinforcements");
	army1 = 3;
	army2 = 4;
...
-- note: depending on where the grey seer reinforcements loaded, could be army 2 or 3
local race_1_hint = "";
local race_1_objective = "";
local race_1_advice = "";

if gb:get_army(ai_alliance, army1, "def_wave_1") then
	ga_ai_race_1 = gb:get_army(ai_alliance, army1);
	
	ga_ai_race_1_wave_1 = gb:get_army(ai_alliance, army1, "def_wave_1");
	
	ga_ai_race_1_wave_2 = gb:get_army(ai_alliance, army1, "def_wave_2");
...
elseif gb:get_army(ai_alliance, army1, "hef_wave_1") then
	ga_ai_race_1 = gb:get_army(ai_alliance, army1);
	
	ga_ai_race_1_wave_1 = gb:get_army(ai_alliance, army1, "hef_wave_1");
	
	ga_ai_race_1_wave_2 = gb:get_army(ai_alliance, army1, "hef_wave_2");
...
elseif gb:get_army(ai_alliance, army1, "lzd_wave_1") then
	ga_ai_race_1 = gb:get_army(ai_alliance, army1);
	
	ga_ai_race_1_wave_1 = gb:get_army(ai_alliance, army1, "lzd_wave_1");
	
	ga_ai_race_1_wave_2 = gb:get_army(ai_alliance, army1, "lzd_wave_2");
...
-- note: depending on where the grey seer reinforcements loaded, could be army 3 or 4
local race_2_hint = "";
local race_2_objective = "";
local race_2_advice = "";

if gb:get_army(ai_alliance, army2, "def_wave_1") then
	ga_ai_race_2 = gb:get_army(ai_alliance, army2);
	
	ga_ai_race_2_wave_1 = gb:get_army(ai_alliance, army2, "def_wave_1");
	
	ga_ai_race_2_wave_2 = gb:get_army(ai_alliance, army2, "def_wave_2");
...
elseif gb:get_army(ai_alliance, army2, "hef_wave_1") then
	ga_ai_race_2 = gb:get_army(ai_alliance, army2);
	
	ga_ai_race_2_wave_1 = gb:get_army(ai_alliance, army2, "hef_wave_1");
	
	ga_ai_race_2_wave_2 = gb:get_army(ai_alliance, army2, "hef_wave_2");
...
elseif gb:get_army(ai_alliance, army2, "lzd_wave_1") then
	ga_ai_race_2 = gb:get_army(ai_alliance, army2);
	
	ga_ai_race_2_wave_1 = gb:get_army(ai_alliance, army2, "lzd_wave_1");
	
	ga_ai_race_2_wave_2 = gb:get_army(ai_alliance, army2, "lzd_wave_2");
...
ga_player:add_winds_of_magic_on_message("battle_started", 100);
