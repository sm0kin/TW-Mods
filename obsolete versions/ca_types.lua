...
--# assume global class UIC_ADDRESS
...
--# assume VFS.exists: function(file_name: string)
...
-- UIC
--# assume CA_UIC.Address: method() --> UIC_ADDRESS
--# assume CA_UIC.Adopt: method(pointer: UIC_ADDRESS)
--# assume CA_UIC.ChildCount: method() --> number
--# assume CA_UIC.ClearSound: method()
--# assume CA_UIC.CreateComponent: method(name: string, path: string) --> UIC_ADDRESS
--# assume CA_UIC.CopyComponent: method(id: string) --> UIC_ADDRESS
...
--# assume CM.apply_dilemma_diplomatic_bonus: method(faction_one_key: string, faction_two_key: string, attitude_bonus: integer)
--get functions
...
--# assume CM.force_add_ancillary: method(char: CA_CHAR, ancillary: string, equip: boolean, cancel_event: boolean)
...
--# assume CM.spawn_agent_at_position: method(owning_faction: CA_FACTION, x: number | int, y: number | int, agent_record: string, agent_subtype_record: string?)

--# assume CM.embed_agent_in_force: method(agent: CA_CHAR, force: CA_MILITARY_FORCE)

--# assume CM.find_valid_spawn_location_for_character_from_settlement: method(faction_key: string, settlement_key: string, on_sea: boolean, in_same_region: boolean, preferred_spawn_distance: (number | integer)?) --> (number, number)
--# assume CM.find_valid_spawn_location_for_character_from_position: method(faction_key: string, x: number | integer, y: number | integer, in_same_region: boolean, preferred_spawn_distance: (number | integer)?) --> (number, number)
--# assume CM.find_valid_spawn_location_for_character_from_character: method(faction_key: string, char_lookup: string, in_same_region: boolean, preferred_spawn_distance: (number | integer)?) --> (number, number)
...
--# assume CM.move_to: method(char_str: string, x: number|int, y: number|int, use_cqi: boolean)

--# assume CM.convert_force_to_type: method(force: CA_MILITARY_FORCE, force_type_key: string)

--# assume CM.add_unit_to_province_mercenary_pool: method(province: CA_REGION, unit_record: string, count: number | int, replenishment_chance_percentage: number | int, max_units: int, max_units_replenished_per_turn: number | int, xp_level: number | int, faction_restricted_record: string | "", subculture_restricted_record: string | "", tech_restricted_record: string | "")

--# assume CM.add_unit_to_faction_mercenary_pool: method(faction: CA_FACTION, unit_record: string, count: number | int, replenishment_chance_percentage: number | int, max_units: int, max_units_replenished_per_turn: number | int, xp_level: number | int, faction_restricted_record: string | "", subculture_restricted_record: string | "", tech_restricted_record: string | "")
...
--events
--# assume CM.trigger_dilemma: method(faction_key: string, dilemma_key: string, trigger_callback: function?)
...
--# assume CM.instantly_set_settlement_primary_slot_level: method(slot: CA_SLOT, level: number)
--# assume CM.region_slot_instantly_upgrade_building: method(slot: CA_SLOT, building_key: string)
--# assume CM.region_slot_instantly_dismantle_building: method(slot: CA_SLOT)
--# assume CM.region_slot_instantly_repair_building: method(slot: CA_SLOT)
...
--# assume CM.foreign_slot_instantly_upgrade_building: method(slot: CA_FOREIGN_SLOT, building_key: string)
--# assume CM.foreign_slot_instantly_dismantle_building: method(slot: CA_FOREIGN_SLOT)
...
--# assume CA_MILITARY_FORCE.can_activate_stance: method(stance: string) --> boolean
...
--# assume CA_FACTION.is_ally_vassal_or_client_state_of: method(faction_obj: CA_FACTION) --> boolean
...
--# assume CA_FACTION.diplomatic_standing_with: method(faction_key: string) --> (number|integer)
...
--# assume CORE.get_env: method () --> table
...
--# assume CORE.is_mod_loaded: method(script_name: string) --> boolean
...
--# assume global UIComponent: function(pointer: UIC_ADDRESS) --> CA_UIC
...
--# assume global out: function(out: string | number | any)  
...
--# assume global distance_squared: function(x1: number|int, y1: number|int, x2: number|int, y2: number|int) --> number|int
