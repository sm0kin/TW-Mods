local WHY_LLH_DEFEATED_TRAITS = {
	["mallobaude"] = "wh2_main_trait_defeated_mallo",		-- Mallobaude
	["zacharias"] = "wh2_main_trait_defeated_zac",       	-- Zacharias the Everliving
	["dieter"] = "wh2_main_trait_defeated_dieter",        	-- Dieter Helsnicht
	["sycamo"] = "wh2_main_trait_defeated_sycamo",         	-- Archmage SYcamo
	["konrad"] = "wh2_main_trait_defeated_konrad"        	-- Konrad von Carstein	
};
