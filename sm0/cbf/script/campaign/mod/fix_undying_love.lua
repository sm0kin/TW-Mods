...
function fix_undying_love()	
	...
	core:add_listener(
		"cbf_apply_couple_bundle_PendingBattle",
		"PendingBattle",
		true,
		function(context)
			cbf_add_undying_love_bundle(context)
		end,
		true
	)
	...
	core:add_listener(
		"cbf_remove_couple_bundle_CharacterCompletedBattle",
		"CharacterCompletedBattle",
		true,
		function(context)
			cbf_remove_undying_love_bundle(context)
		end,
		true
	)
	core:add_listener(
		"cbf_remove_couple_bundle_CharacterTurnStart",
		"CharacterTurnStart",
		true,
		function(context)
			cbf_remove_undying_love_bundle(context)
...
function cbf_add_undying_love_bundle(context)
...
function cbf_remove_undying_love_bundle(context)
