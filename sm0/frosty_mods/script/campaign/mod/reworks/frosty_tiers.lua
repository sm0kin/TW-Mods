...
function frosty_tiers()
	...
	if not not mcm then
        ...
        --NEW TWEAKER: DISABLE MOD (CHECK IF ENABLED OR ELSE DON'T CONTINUE?)
        ...
        --NEW TWEAKER THAT REPLACES ownerScope, will require adjustments for upgrade_capitals and upgrade_horde arguments/parameters
        ...
        _04_hordeTier:add_option("4", "Tier IV", "Sets the Horde Starting Tier to IV.")
        _04_hordeTier:add_option("6", "No Changes (Vanilla)", "Sets the Horde Starting Tier to IV.")
		_04_hordeTier:add_option("2", "Tier II", "Sets the Horde Starting Tier to II.")
        _04_hordeTier:add_option("3", "Tier III", "Sets the Horde Starting Tier to III.")
        _04_hordeTier:add_option("5", "Tier V", "Sets the Horde Starting Tier to V.")
		...
		_05_settlementScope:add_option("e1_faction_capitals", "No", "")
