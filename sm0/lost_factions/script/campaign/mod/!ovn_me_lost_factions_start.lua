...
local function amazon_setup()
	...
	cm:add_unit_to_faction_mercenary_pool(faction_name, "roy_amz_ror_anakondas_amazons", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
...
local function araby_setup()
	...
	cm:add_unit_to_faction_mercenary_pool(faction_name, "ovn_jag_ror", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(faction_name, "ovn_jez_ror", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(faction_name, "ovn_bom_ror", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(faction_name, "ovn_knights_ror", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(faction_name, "ovn_cat_knights_ror", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(faction_name, "ovn_elephant_ror", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(faction_name, "ovn_arb_mon_war_elephant_ror", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
...
local function blood_dragon_setup()
	...
	if cm:get_faction("wh_main_vmp_rival_sylvanian_vamps"):is_human() then
...
local blood_dragons_leader_cqi = blood_dragons:faction_leader():command_queue_index();
	...
	cm:callback(function() cm:kill_character(blood_dragons_leader_cqi, true, true) end, 1)
    cm:callback(function() cm:disable_event_feed_events(false, "", "wh_event_subcategory_character_deaths", "") end, 1.1)

		cm:override_building_chain_display("wh_main_DWARFS_settlement_major", "wh_main_VAMPIRES_settlement_major", "wh_main_southern_grey_mountains_karak_norn")
		...
		cm:force_religion_factors("wh_main_southern_grey_mountains_karak_norn", "wh_main_religion_undeath", 0.5, "wh_main_religion_untainted", 0.5)
		...
		cm:region_slot_instantly_upgrade_building(bhufdar_region:settlement():active_secondary_slots():item_at(2), "wh_main_dwf_garrison_2")
...
local function citadel_setup()
	...
	cm:override_building_chain_display("wh2_main_lzd_settlement_minor_coast", "wh2_main_hef_settlement_major_coast", "wh2_main_headhunters_jungle_mangrove_coast")
	...
	cm:region_slot_instantly_upgrade_building(mangrove_region:settlement():active_secondary_slots():item_at(1), "ovn_Citadel_of_dusk")
...
local function halflings_setup()
	...
	cm:add_unit_to_faction_mercenary_pool(moot, "wh2_dlc13_emp_cav_pistoliers_1_imperial_supply", 1, 0, 5, 0, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(moot, "halfling_warfoot", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(moot, "sr_ogre_ror", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(moot, "halfling_cock", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(moot, "wh_main_mtl_veh_soupcart", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(moot, "halfling_cat_ror", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);

	-- ally with da emprah
	cm:force_alliance("wh2_main_emp_the_moot", "wh_main_emp_empire", true)

	--Halfling Lord for the Empire
	cm:spawn_character_to_pool("wh_main_emp_empire", "names_name_999982320", "", "", "", 18, true, "general", "ovn_hlf_ll", false, "")
end
...
local function trollz_setup()
	...
	cm:heal_garrison(cm:get_region("wh_main_rib_peaks_grom_peak"):cqi());
		...
		cm:add_unit_to_faction_mercenary_pool(troll, "elo_red_avalanche", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
		cm:add_unit_to_faction_mercenary_pool(troll, "elo_shipwreckers", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
		cm:add_unit_to_faction_mercenary_pool(troll, "elo_kin", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
		cm:add_unit_to_faction_mercenary_pool(troll, "elo_night_trolls_ror", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
...
local function treeblood_setup()
	...
	cm:add_unit_to_faction_mercenary_pool(faction_name, "wh_pro04_nor_mon_marauder_warwolves_ror_0", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(faction_name, "ovn_killing_eye", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(faction_name, "wh_pro04_nor_mon_fimir_ror_0", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(faction_name, "ovn_gharnus_demon", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(faction_name, "wh_pro04_chs_mon_chaos_spawn_ror_0", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
...
local function fimir_setup()
	...
	local floating_region = cm:model():world():region_manager():region_by_key("wh2_main_marshes_of_madness_floating_village")
	...
	local baersonlings_region = cm:model():world():region_manager():region_by_key("wh_main_goromandy_mountains_baersonlings_camp")
...
local function grudgebringers_setup()
	...
	cm:add_unit_to_faction_mercenary_pool(gru, "wh2_dlc13_emp_cav_pistoliers_1_imperial_supply", 1, 0, 5, 0, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(gru, "ragnar_wolves", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(gru, "grudgebringer_infantry", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(gru, "grudgebringer_cannon", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(gru, "grudgebringer_crossbow", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(gru, "treeman_gnarl_fist", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(gru, "urblab_rotgut_mercenary_ogres", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
	cm:add_unit_to_faction_mercenary_pool(gru, "galed_elf_archers", unit_count, rcp, max_units, murpt, xp_level, frr, srr, trr, true);
...
local function dreadking_setup()
	...
	local pyramid_region = cm:model():world():region_manager():region_by_key("wh2_main_great_mortis_delta_black_pyramid_of_nagash")
