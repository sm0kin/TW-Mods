...
preferance1:add_dropdown_value("player", "Prefer Player", "", true)
...
preferance2:add_dropdown_value("relation", "Relation based", "", true)
...
preferance3:add_dropdown_value("disable", "Disable", "", true)
