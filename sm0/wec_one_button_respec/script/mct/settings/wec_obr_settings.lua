...
--local b_en_cost_disabled_txt = effect.get_localised_string(loc_prefix.."b_en_cost_disabled_txt")
--local b_en_cost_disabled_tt = effect.get_localised_string(loc_prefix.."b_en_cost_disabled_tt")
--local b_en_cost_firstforfree_txt = effect.get_localised_string(loc_prefix.."b_en_cost_firstforfree_txt")
--local b_en_cost_firstforfree_tt = effect.get_localised_string(loc_prefix.."b_en_cost_firstforfree_tt")
--local b_en_cost_enabled_txt = effect.get_localised_string(loc_prefix.."b_en_cost_enabled_txt")
--local b_en_cost_enabled_tt = effect.get_localised_string(loc_prefix.."b_en_cost_enabled_tt")
--en_cost:add_dropdown_value("disabled", b_en_cost_disabled_txt, b_en_cost_disabled_tt, true)
--en_cost:add_dropdown_value("firstforfree", b_en_cost_firstforfree_txt, b_en_cost_firstforfree_tt)
--en_cost:add_dropdown_value("enabled", b_en_cost_enabled_txt, b_en_cost_enabled_tt)
