...
local ci_max_num_hordes = {{4, 4, 5, 6, 7}, {6, 6, 7, 8, 9}}; --{{3, 3, 4, 5, 6}, {5, 5, 6, 7, 8}};
		...
		if is_valid_spawn_point(x, y) then
			cm:create_force_with_general(
				...
				function(cqi)
					...
					if char_details["agent_subtype"] == "Exalt_Lord_of_Change" then cm:force_add_trait(char_str, "wh_main_trait_name_dummy_the_ever-watcher", true) end;
					cm:apply_effect_bundle_to_characters_force("wh_main_bundle_military_upkeep_free_force", cqi, 0, true);
