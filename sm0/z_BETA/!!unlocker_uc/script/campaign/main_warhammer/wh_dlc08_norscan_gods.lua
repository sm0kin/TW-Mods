...
NORSCAN_REWARD_LORD_OF_CHANGE = {
	["wh_dlc08_nor_norsca"] = "1007509378",
	["wh_dlc08_nor_wintertooth"] = "2107575863",
	["wh_main_nor_aesling"] = "1420880470",
	["wh_main_nor_baersonling"] = "378057310",
	["wh_main_nor_bjornling"] = "1728062501",
	["wh_main_nor_graeling"] = "249173323",
	["wh_main_nor_skaeling"] = "1418937091",
	["wh_main_nor_varg"] = "1979999722",
	["wh2_main_nor_aghol"] = "719401825",
	["wh2_main_nor_mung"] = "552031087",
	["wh2_main_nor_skeggi"] = "762637331"
};
...
GOD_KEY_TO_CHALLENGER_DETAILS = {
	["khorne"] = {make_faction_leader = true, agent_subtype = "Lord_Khorne", forename = "names_name_635561999", clan_name = "", family_name = "", other_name = "", effect_bundle = "wh_main_bundle_military_upkeep_free_force_special_character_unbreakable"},
	["slaanesh"] = {make_faction_leader = true, agent_subtype = "Lord_Slaanesh", forename = "names_name_1572470675", clan_name = "", family_name = "", other_name = "", effect_bundle = "wh_main_bundle_military_upkeep_free_force_special_character_unbreakable"},
	["nurgle"] = {make_faction_leader = true, agent_subtype = "Lord_Nurgle", forename = "names_name_327875186", clan_name = "", family_name = "", other_name = "", effect_bundle = "wh_main_bundle_military_upkeep_free_force_special_character_unbreakable"},
...
function Add_Norscan_Gods_Listeners()
	...
	out("\tNorscan factions God favour...");
	...
	if ((cm:is_new_game() == true) and (cm:get_campaign_name() == "main_warhammer")) then
		...
		cm:lock_starting_general_recruitment(NORSCAN_REWARD_LORD_OF_CHANGE["wh_main_nor_aesling"], "wh_main_nor_aesling");
		cm:lock_starting_general_recruitment(NORSCAN_REWARD_LORD_OF_CHANGE["wh_main_nor_baersonling"], "wh_main_nor_baersonling");
		cm:lock_starting_general_recruitment(NORSCAN_REWARD_LORD_OF_CHANGE["wh_main_nor_bjornling"], "wh_main_nor_bjornling");
		cm:lock_starting_general_recruitment(NORSCAN_REWARD_LORD_OF_CHANGE["wh_main_nor_graeling"], "wh_main_nor_graeling");
		cm:lock_starting_general_recruitment(NORSCAN_REWARD_LORD_OF_CHANGE["wh_main_nor_skaeling"], "wh_main_nor_skaeling");
		cm:lock_starting_general_recruitment(NORSCAN_REWARD_LORD_OF_CHANGE["wh_main_nor_varg"], "wh_main_nor_varg");
		cm:lock_starting_general_recruitment(NORSCAN_REWARD_LORD_OF_CHANGE["wh2_main_nor_aghol"], "wh2_main_nor_aghol");
		cm:lock_starting_general_recruitment(NORSCAN_REWARD_LORD_OF_CHANGE["wh2_main_nor_mung"], "wh2_main_nor_mung");
		cm:lock_starting_general_recruitment(NORSCAN_REWARD_LORD_OF_CHANGE["wh2_main_nor_skeggi"], "wh2_main_nor_skeggi");
		...
		cm:add_event_restricted_unit_record_for_faction(NORSCAN_REWARD_HELL_CANNON, "wh_main_nor_aesling", "norsca_ror_unlock_reason");
		cm:add_event_restricted_unit_record_for_faction(NORSCAN_REWARD_HELL_CANNON, "wh_main_nor_baersonling", "norsca_ror_unlock_reason");
		cm:add_event_restricted_unit_record_for_faction(NORSCAN_REWARD_HELL_CANNON, "wh_main_nor_bjornling", "norsca_ror_unlock_reason");
		cm:add_event_restricted_unit_record_for_faction(NORSCAN_REWARD_HELL_CANNON, "wh_main_nor_graeling", "norsca_ror_unlock_reason");
		cm:add_event_restricted_unit_record_for_faction(NORSCAN_REWARD_HELL_CANNON, "wh_main_nor_skaeling", "norsca_ror_unlock_reason");
		cm:add_event_restricted_unit_record_for_faction(NORSCAN_REWARD_HELL_CANNON, "wh_main_nor_varg", "norsca_ror_unlock_reason");
		cm:add_event_restricted_unit_record_for_faction(NORSCAN_REWARD_HELL_CANNON, "wh2_main_nor_aghol", "norsca_ror_unlock_reason");
		cm:add_event_restricted_unit_record_for_faction(NORSCAN_REWARD_HELL_CANNON, "wh2_main_nor_mung", "norsca_ror_unlock_reason");
		cm:add_event_restricted_unit_record_for_faction(NORSCAN_REWARD_HELL_CANNON, "wh2_main_nor_skeggi", "norsca_ror_unlock_reason");
		...
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_war_mammoth_ror_1", "wh_main_nor_aesling", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_war_mammoth_ror_1", "wh_main_nor_baersonling", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_war_mammoth_ror_1", "wh_main_nor_bjornling", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_war_mammoth_ror_1", "wh_main_nor_graeling", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_war_mammoth_ror_1", "wh_main_nor_skaeling", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_war_mammoth_ror_1", "wh_main_nor_varg", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_war_mammoth_ror_1", "wh2_main_nor_aghol", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_war_mammoth_ror_1", "wh2_main_nor_mung", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_war_mammoth_ror_1", "wh2_main_nor_skeggi", "norsca_monster_hunt_ror_unlock");
		...
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_frost_wyrm_ror_0", "wh_main_nor_aesling", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_frost_wyrm_ror_0", "wh_main_nor_baersonling", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_frost_wyrm_ror_0", "wh_main_nor_bjornling", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_frost_wyrm_ror_0", "wh_main_nor_graeling", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_frost_wyrm_ror_0", "wh_main_nor_skaeling", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_frost_wyrm_ror_0", "wh_main_nor_varg", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_frost_wyrm_ror_0", "wh2_main_nor_aghol", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_frost_wyrm_ror_0", "wh2_main_nor_mung", "norsca_monster_hunt_ror_unlock");
		cm:add_event_restricted_unit_record_for_faction("wh_dlc08_nor_mon_frost_wyrm_ror_0", "wh2_main_nor_skeggi", "norsca_monster_hunt_ror_unlock");
		...
		if cm:is_multiplayer() == false then
			...
			cm:callback(function()
				for i = 1, #missions_to_spawn do
					...
					cm:trigger_mission(faction_key, missions_to_spawn[i], true, true);
				end
			end, 1);
		end
	end
...
function Spawn_Challenger(faction_key, god_key, is_mp)
	...
	challenger_invasion:add_character_experience(99000); -- Level 30
...
events.MissionSucceeded[#events.MissionSucceeded+1] =
function (context)
	ChallengerMissionCheck(context);
end
events.MissionCancelled[#events.MissionCancelled+1] =
function (context)
...
function ChallengerMissionCheck(context)
	...
	if mission_key == "wh_dlc08_qb_chs_final_battle_khorne" or mission_key == "wh_dlc08_qb_chs_final_battle_nurgle" or mission_key == "wh_dlc08_qb_chs_final_battle_slaanesh" or mission_key == "wh_dlc08_qb_chs_final_battle_tzeentch" then
		if cm:is_multiplayer() == false then
			...
			cm:trigger_dilemma(faction_key, NORSCA_ARCHAON_DILEMMA, true);
		end
	--------------------------------------------
...
function Norsca_UniqueAgentSpawned(context)
	...
	if agent:is_null_interface() == false and agent:character_subtype("dlc08_nor_kihar") then
		if agent:rank() < 40 then
			local cqi = agent:cqi();
			cm:add_agent_experience("character_cqi:"..cqi, 70000);
			...
			cm:callback(function()
				...
				cm:force_add_ancillary("character_cqi:"..cqi, "wh_dlc08_anc_mount_nor_kihar_chaos_dragon");
			end, 0.5);
		end
	end
end
...
function Setup_Challenger_Armies()
	...
	for raze_id, god_key in pairs(RAZE_ID_TO_GOD_KEY) do
		ram:new_force("challenger_"..god_key);
					...
					if god_key == "tzeentch" then
		-- ==========================TZEENTCH=====================
				ram:add_unit("challenger_"..god_key, "Hellcannon_cult_wh2", 1);
				ram:add_unit("challenger_"..god_key, "Tzeentch_knights", 4);
				ram:add_unit("challenger_"..god_key, "Tzeentch_warriors", 10);
				ram:add_unit("challenger_"..god_key, "Chaos_Chosen_2", 2);
				ram:add_unit("challenger_"..god_key, "chs_prime_staff", 1);
				ram:add_unit("challenger_"..god_key, "Changers", 6);
				ram:add_unit("challenger_"..god_key, "Pink_Horrors", 2);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_mon_chaos_spawn", 4);
				ram:add_unit("challenger_"..god_key, "Lord_of_Change", 1);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_mon_giant", 1);
				
						elseif god_key == "khorne" then		
			-- ==========================KHORNE=====================			
				ram:add_unit("challenger_"..god_key, "Hellcannon_cult_wh2", 1);
				ram:add_unit("challenger_"..god_key, "Norse_Huskarls", 1);
				ram:add_unit("challenger_"..god_key, "Khorne_knights", 2);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_cav_marauder_horsemen_0", 1);
				ram:add_unit("challenger_"..god_key, "Bloodletters", 1);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_inf_chaos_marauders_1", 2);
				ram:add_unit("challenger_"..god_key, "Khorne_warriors", 5);
				ram:add_unit("challenger_"..god_key, "Khorne_Skulltakers", 3);
				ram:add_unit("challenger_"..god_key, "chs_forsaken_giant", 1);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_mon_chaos_warhounds_0", 1);
				ram:add_unit("challenger_"..god_key, "Fleshhounds", 2);
				ram:add_unit("challenger_"..god_key, "Bloodthirster", 1);		
							
							elseif god_key == "nurgle" then
				-- ==========================NURGLE=====================			
				ram:add_unit("challenger_"..god_key, "Plague_Cannon", 1);
				ram:add_unit("challenger_"..god_key, "Nurgle_knights", 4);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_cav_marauder_horsemen_0", 1);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_cav_marauder_horsemen_1", 1);
				ram:add_unit("challenger_"..god_key, "Nurgle_warriors", 5);
				ram:add_unit("challenger_"..god_key, "Nurgle_PlagueReapers", 5);
				ram:add_unit("challenger_"..god_key, "Afflicted", 3);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_mon_chaos_warhounds_1", 2);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_mon_giant", 1);
				ram:add_unit("challenger_"..god_key, "Plaguebearers", 3);
				ram:add_unit("challenger_"..god_key, "Great_Unclean_One", 1);
			
								elseif god_key == "slaanesh" then					
		-- 	==========================SLAANESH=====================			
			
				ram:add_unit("challenger_"..god_key, "Slaanesh_Pleasure_Cannon", 1);
				ram:add_unit("challenger_"..god_key, "Slaanesh_Riders", 2);
				ram:add_unit("challenger_"..god_key, "Slaanesh_Chariot", 1);
				ram:add_unit("challenger_"..god_key, "harad_chaos_cultists", 2);
				ram:add_unit("challenger_"..god_key, "Daemonettes", 2);
				ram:add_unit("challenger_"..god_key, "Slaanesh_lancers", 4);
				ram:add_unit("challenger_"..god_key, "Blessed", 2);
				ram:add_unit("challenger_"..god_key, "Slaanesh_warriors", 5);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_mon_chaos_spawn", 3);
				ram:add_unit("challenger_"..god_key, "wh_main_chs_mon_chaos_warhounds_0", 1);
				ram:add_unit("challenger_"..god_key, "Daemonettes_Mounted", 2);
